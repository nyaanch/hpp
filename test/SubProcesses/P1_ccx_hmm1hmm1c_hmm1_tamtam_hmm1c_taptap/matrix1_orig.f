...
C     
C     Process: c c~ > hmm1 hmm1c BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=4 @1
...
C     ----------
     ...
     $    ABS(MDL_MHH5*SMALL_WIDTH_TREATMENT)), MDL_WHH5)
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MU2
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL OXXXXX(P(0,2),MDL_MU2,NHEL(2),-1*IC(2),W(1,2))
     ...
     $ ,6))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27733,GC_27734,MDL_MHH1,
     $  FK_MDL_WHH1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2199,AMP(1))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27735,GC_27736,MDL_MHH2,
     $  FK_MDL_WHH2,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2203,AMP(2))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27737,GC_27738,MDL_MHH3,
     $  FK_MDL_WHH3,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2207,AMP(3))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27739,GC_27740,MDL_MHH4,
     $  FK_MDL_WHH4,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2211,AMP(4))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27741,GC_27742,MDL_MHH5,
     $  FK_MDL_WHH5,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2215,AMP(5))
      CALL FFV2_4P0_3(W(1,1),W(1,2),GC_30952,GC_30951,ZERO, FK_ZERO
     $ ,W(1,3))
C     Amplitude(s) for diagram number 6
      CALL SSV1_0(W(1,5),W(1,6),W(1,3),GC_11314,AMP(6))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_30976,GC_30975,MDL_MZ, FK_MDL_WZ
     $ ,W(1,3))
C     Amplitude(s) for diagram number 7
      CALL SSV1_0(W(1,5),W(1,6),W(1,3),GC_11316,AMP(7))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_30982,GC_30981,MDL_MZP,
     $  FK_MDL_WZP,W(1,3))
