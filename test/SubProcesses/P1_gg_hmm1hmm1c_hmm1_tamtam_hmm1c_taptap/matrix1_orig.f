...
C     
C     Process: g g > hmm1 hmm1c BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=4 @1
...
C     ----------
     ...
     $ ,6))
      CALL VVSPP_3(W(1,1),W(1,2),GC_31207,MDL_MHH1, FK_MDL_WHH1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2199,AMP(1))
      CALL VVSPP_3(W(1,1),W(1,2),GC_31209,MDL_MHH2, FK_MDL_WHH2,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2203,AMP(2))
      CALL VVSPP_3(W(1,1),W(1,2),GC_31211,MDL_MHH3, FK_MDL_WHH3,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2207,AMP(3))
      CALL VVSPP_3(W(1,1),W(1,2),GC_31213,MDL_MHH4, FK_MDL_WHH4,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2211,AMP(4))
      CALL VVSPP_3(W(1,1),W(1,2),GC_31215,MDL_MHH5, FK_MDL_WHH5,W(1,3))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +00)*AMP(2)+(-2.000000000000000D+00)*AMP(3)+(
     $ -2.000000000000000D+00)*AMP(4)+(-2.000000000000000D+00)*AMP(5)
