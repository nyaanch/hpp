...
C     
C     Process: s s~ > hmm1 hmm1c BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=4 @1
C     *   Decay: hmm1 > ta- ta- BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=2
C     *   Decay: hmm1c > ta+ ta+ BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Needed for v4 models
      ...
      DOUBLE PRECISION FK_MDL_WHH4
      DOUBLE PRECISION FK_MDL_WHH2
      DOUBLE PRECISION FK_MDL_WHH1
      DOUBLE PRECISION FK_MDL_WHMM1
      DOUBLE PRECISION FK_ZERO
      DOUBLE PRECISION FK_MDL_WHH5
      DOUBLE PRECISION FK_MDL_WZ
      DOUBLE PRECISION FK_MDL_WZP
      DOUBLE PRECISION FK_MDL_WHH3
      SAVE FK_MDL_WHH4
      SAVE FK_MDL_WHH2
      SAVE FK_MDL_WHH1
      SAVE FK_MDL_WHMM1
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WHMM1.NE.0D0) FK_MDL_WHMM1 = SIGN(MAX(ABS(MDL_WHMM1),
     $    ABS(MDL_MHMM1*SMALL_WIDTH_TREATMENT)), MDL_WHMM1)
     ...
     $    ABS(MDL_MZP*SMALL_WIDTH_TREATMENT)), MDL_WZP)
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MD2
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_ME3
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WHH1.NE.0D0) FK_MDL_WHH1 = SIGN(MAX(ABS(MDL_WHH1),
     $    ABS(MDL_MHH1*SMALL_WIDTH_TREATMENT)), MDL_WHH1)
        IF(MDL_WHH2.NE.0D0) FK_MDL_WHH2 = SIGN(MAX(ABS(MDL_WHH2),
     $    ABS(MDL_MHH2*SMALL_WIDTH_TREATMENT)), MDL_WHH2)
        IF(MDL_WHH3.NE.0D0) FK_MDL_WHH3 = SIGN(MAX(ABS(MDL_WHH3),
     $    ABS(MDL_MHH3*SMALL_WIDTH_TREATMENT)), MDL_WHH3)
        IF(MDL_WHH4.NE.0D0) FK_MDL_WHH4 = SIGN(MAX(ABS(MDL_WHH4),
     $    ABS(MDL_MHH4*SMALL_WIDTH_TREATMENT)), MDL_WHH4)
        IF(MDL_WHH5.NE.0D0) FK_MDL_WHH5 = SIGN(MAX(ABS(MDL_WHH5),
     $    ABS(MDL_MHH5*SMALL_WIDTH_TREATMENT)), MDL_WHH5)
      ...
      CALL IXXXXX(P(0,1),MDL_MD2,NHEL(1),+1*IC(1),W(1,1))
      CALL OXXXXX(P(0,2),MDL_MD2,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,3),MDL_ME3,NHEL(3),-1*IC(3),W(1,3))
      CALL OXXXXX(P(0,4),MDL_ME3,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS2C1_3(W(1,3),W(1,4),GC_26761,MDL_MHMM1, FK_MDL_WHMM1,W(1
     $ ,5))
      CALL OXXXXX(P(0,5),MDL_ME3,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),MDL_ME3,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS1C1_3(W(1,3),W(1,4),GC_29155,MDL_MHMM1, FK_MDL_WHMM1,W(1
     $ ,6))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_26341,GC_26342,MDL_MHH1,
     $  FK_MDL_WHH1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2199,AMP(1))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_26343,GC_26344,MDL_MHH2,
     $  FK_MDL_WHH2,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2203,AMP(2))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_26345,GC_26346,MDL_MHH3,
     $  FK_MDL_WHH3,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2207,AMP(3))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_26347,GC_26348,MDL_MHH4,
     $  FK_MDL_WHH4,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2211,AMP(4))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_26349,GC_26350,MDL_MHH5,
     $  FK_MDL_WHH5,W(1,3))
C     Amplitude(s) for diagram number 5
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2215,AMP(5))
      CALL FFV2_4P0_3(W(1,1),W(1,2),GC_30856,GC_30855,ZERO, FK_ZERO
     $ ,W(1,3))
C     Amplitude(s) for diagram number 6
      CALL SSV1_0(W(1,5),W(1,6),W(1,3),GC_11314,AMP(6))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_30862,GC_30861,MDL_MZ, FK_MDL_WZ
     $ ,W(1,3))
C     Amplitude(s) for diagram number 7
      CALL SSV1_0(W(1,5),W(1,6),W(1,3),GC_11316,AMP(7))
      CALL FFV2_4_3(W(1,1),W(1,2),GC_30868,GC_30867,MDL_MZP,
     $  FK_MDL_WZP,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL SSV1_0(W(1,5),W(1,6),W(1,3),GC_11318,AMP(8))
