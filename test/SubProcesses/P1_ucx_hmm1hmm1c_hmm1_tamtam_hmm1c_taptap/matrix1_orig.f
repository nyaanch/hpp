...
C     
C     Process: u c~ > hmm1 hmm1c BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=4 @1
...
C     ----------
     ...
     $ ,6))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27703,GC_27704,MDL_MHH1,
     $  FK_MDL_WHH1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2199,AMP(1))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27705,GC_27706,MDL_MHH2,
     $  FK_MDL_WHH2,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2203,AMP(2))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27707,GC_27708,MDL_MHH3,
     $  FK_MDL_WHH3,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2207,AMP(3))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27709,GC_27710,MDL_MHH4,
     $  FK_MDL_WHH4,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2211,AMP(4))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27711,GC_27712,MDL_MHH5,
     $  FK_MDL_WHH5,W(1,3))
