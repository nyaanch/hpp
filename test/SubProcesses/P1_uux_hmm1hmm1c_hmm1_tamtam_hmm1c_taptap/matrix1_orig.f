...
C     
C     Process: u u~ > hmm1 hmm1c BSM<=1 HIG<=1 HIW<=1 WEIGHTED<=4 @1
...
C     ----------
     ...
     $    ABS(MDL_MHH5*SMALL_WIDTH_TREATMENT)), MDL_WHH5)
        IF(ZERO.NE.0D0) FK_ZERO = SIGN(MAX(ABS(ZERO), ABS(MDL_MU1
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL OXXXXX(P(0,2),MDL_MU1,NHEL(2),-1*IC(2),W(1,2))
     ...
     $ ,6))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27693,GC_27694,MDL_MHH1,
     $  FK_MDL_WHH1,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2199,AMP(1))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27695,GC_27696,MDL_MHH2,
     $  FK_MDL_WHH2,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2203,AMP(2))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27697,GC_27698,MDL_MHH3,
     $  FK_MDL_WHH3,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2207,AMP(3))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27699,GC_27700,MDL_MHH4,
     $  FK_MDL_WHH4,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL SSS1_0(W(1,3),W(1,5),W(1,6),GC_2211,AMP(4))
      CALL FFS1_2_3(W(1,1),W(1,2),GC_27701,GC_27702,MDL_MHH5,
     $  FK_MDL_WHH5,W(1,3))
